...
public class ExternalChainingHashMap<K, V> {
    ...
    public V put(K key, V value) {
        if (key == null || value == null){
            throw new IllegalArgumentException("Cannot add item with null key or value");
        }
        ...
        ExternalChainingMapEntry<K, V> toAdd = new ExternalChainingMapEntry<>(key, value);
    ...
    private void resizeBackingTable(int length) {
        ...
        for (int i = 0; i < table.length; i++){
            ...
            while (current != null){
                ...
                newEntry.setNext(newTable[newIndex]);
